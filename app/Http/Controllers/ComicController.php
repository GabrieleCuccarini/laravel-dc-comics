...
class ComicController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        foreach ($comicslist as $comic2) {
            $newComic = new Comic();
            $newComic->title = $comic2['title'];
            $newComic->description = $comic2['description'];
            $newComic->price = $comic2['price'];
            $newComic->series = $comic2['series'];
            $newComic->type = $comic2['type'];
            $newComic->save();
        }
